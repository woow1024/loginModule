...
int CMarkup::GetChildAttrib(MCD_CSTR szAttrib, int nDefault)
{
	MCD_STR msValue = GetChildAttrib(szAttrib);
	...
	{
		return _tstoi(msValue);
	}
}

bool CMarkup::IsHasChildElemnt()
{
#pragma GW_message(CMarkup::IsHasChildElemnt功能还未实现)
	return false;
}
