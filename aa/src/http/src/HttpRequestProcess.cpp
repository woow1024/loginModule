...
HttpRequestProcess::HttpRequestProcess ( char* buffer, long length ) :
...
bool HttpRequestProcess::create ( char* buffer, long length )
{
	// set state
	_processState = REQ_REQUEST;
	_buffer		  = buffer;
...
bool HttpRequestProcess::process ( char* buffer, long length )
{
